...
def replicas = "1"
def devProject = "s122d2-dev" // TODO: Your dev project name goes here
def testProject = "s122d2-test" // TODO: Your test project name goes here
def prodProject = "s122d2-prod" // TODO: Your prod project name goes here
        ...
        stage("Setup") {
            steps {
                script {
                    openshift.withCluster(){
                    echo "in script"
                    openshift.withProject("s122d2-dev") {
